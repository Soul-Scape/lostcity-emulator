...
// inspired by https://github.com/rsmod/rsmod
...
// Forward declarations to avoid circular deps - use 'any' with duck typing
export class NpcList extends EntityList<any> {
    constructor(size: number) {
        super(size, 0);
    }
}

export class PlayerList extends EntityList<any> {
    constructor(size: number) {
        super(size, 1);
    }
